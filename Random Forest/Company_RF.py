# -*- coding: utf-8 -*-
"""
Created on Mon Oct 16 14:27:44 2023
...
#Importing Dataset
Company_Data=pd.read_csv("C:/Users/Admin/Downloads/Company_Data (1).csv")
Company_Data
...
model_data = data_[['Price','Advertising','Population','Income','Age','ShelveLoc','Sales']]
model_data.head()
...
ABR = AdaBoostRegressor(n_estimators=100,base_estimator="deprecated",
                  learning_rate=1.0,estimator=None)
